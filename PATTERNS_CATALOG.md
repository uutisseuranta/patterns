# PATTERNS_CATALOG.md — D-CENT Pattern Lab -integraatio

> **Huom:** Tämä tiedosto on palautettu `uutisseuranta.github.io`-repositorion muutoshistoriasta.
> Alkuperäinen tiedosto (`patterns.md`) poistettiin tiketti [#51](https://github.com/uutisseuranta/uutisseuranta.github.io/issues/51) yhteydessä ja sen sisältö siirrettiin tähän `patterns`-repoon.
